...
const LocationManagement = () => {
    ...
    const saveLocation = async () => {
        ...
        try {
            if (formData.id) {
                // Update
                await axios.put(`/api/locations/${formData.id}`, data, {
            ...
            <div className="location-form">
                ...
                <div className="panel-group">
                    ...
                    <RichTextEditor
                        ...
                        onChange={(contentVal) => setFormData({ ...formData, content: contentVal })}
                        placeholder="Write location page content here..."
                    />
                </div>
